 ...
 */
export const makeRandomInt = (maxNonInclusive: number): number =>
 ...
 */
export const randomArrayElement = (array: any[] | string): any | string | null =>
  array.length > 0 ? array[makeRandomInt(array.length)] : null;
