...
import type { DataSetName, ChainId } from '../views';
...
export class InvalidModuleError extends Error {
  constructor(moduleId: ModuleId | null | undefined) {
    super(
      `InvalidModuleError: Module [${moduleId}] not imported. Did you forget to call client.importDataSets() ?`,
    );
...
export class InvalidDataSetError extends Error {
  constructor(moduleId: ModuleId | null | undefined, dataSetName: DataSetName | null | undefined) {
    super(
      `InvalidDataSetError: DataSet [${dataSetName}] of Module [${moduleId}] not imported. Did you forget to call client.importDataSets() ?`,
    );
...
export class InvalidChainError extends Error {
  constructor(moduleId: ModuleId | null | undefined, chainId: ChainId | null | undefined) {
    super(
      `InvalidChainError: Chain [${chainId}] of Module [${moduleId}] not imported. Did you forget to call client.importDataSets() ?`,
    );
