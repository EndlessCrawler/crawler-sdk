...
import { Utils, EndlessCrawler } from '../src';
...
describe('* utils', () => {
  ...
  it('bigIntToByteArray()', () => {
    expect(Utils.bigIntToByteArray(0), 'bigIntToByteArray(): bad input').toEqual(
      new Uint8Array([0]),
    );
    expect(Utils.bigIntToByteArray(0n), 'bigIntToByteArray(): bad input').toEqual(
      new Uint8Array([0]),
    );
    expect(Utils.bigIntToByteArray('0'), 'bigIntToByteArray(): bad input').toEqual(
      new Uint8Array([0]),
    );
    expect(Utils.bigIntToByteArray('0x0'), 'bigIntToByteArray(): bad input').toEqual(
      new Uint8Array([0]),
    );
    expect(Utils.bigIntToByteArray('0x00'), 'bigIntToByteArray(): bad input').toEqual(
      new Uint8Array([0]),
    );

    expect(Utils.bigIntToByteArray(1), 'bigIntToByteArray(): bad input').toEqual(
      new Uint8Array([1]),
    );
    expect(Utils.bigIntToByteArray(1n), 'bigIntToByteArray(): bad input').toEqual(
      new Uint8Array([1]),
    );
    expect(Utils.bigIntToByteArray('1'), 'bigIntToByteArray(): bad input').toEqual(
      new Uint8Array([1]),
    );
    expect(Utils.bigIntToByteArray('0x1'), 'bigIntToByteArray(): bad input').toEqual(
      new Uint8Array([1]),
    );
    expect(Utils.bigIntToByteArray('0x01'), 'bigIntToByteArray(): bad input').toEqual(
      new Uint8Array([1]),
    );
    expect(Utils.bigIntToByteArray('0x001'), 'bigIntToByteArray(): bad input').toEqual(
      new Uint8Array([1]),
    );
    expect(Utils.bigIntToByteArray('0x0001'), 'bigIntToByteArray(): bad input').toEqual(
      new Uint8Array([1]),
    );
    expect(Utils.bigIntToByteArray('0x010203'), 'bigIntToByteArray(): bad input').toEqual(
      new Uint8Array([1, 2, 3]),
    );
    expect(Utils.bigIntToByteArray('0x010201'), 'bigIntToByteArray(): bad input').toEqual(
      new Uint8Array([1, 2, 1]),
    );
    expect(Utils.bigIntToNumberArray('0x010201'), 'bigIntToByteArray(): bad input').toEqual([
      1, 2, 1,
    ]);

    expect(Utils.bigIntToByteArray(255n), 'bigIntToByteArray(): bad input').toEqual(
      new Uint8Array([255]),
    );
    expect(Utils.bigIntToByteArray(256n), 'bigIntToByteArray(): bad input').toEqual(
      new Uint8Array([1, 0]),
    );
    expect(Utils.bigIntToByteArray(CoordMax), 'bigIntToByteArray(): bad input').toEqual(
