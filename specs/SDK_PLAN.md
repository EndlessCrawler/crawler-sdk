...
| **A chamber's internal tile arrangement** | **`Tilemap`** / **`Bitmap`** _(existing)_ | The *chamber* layout — the reason "layout" is off-limits elsewhere. |
